...
// shared secret (the data is already anonymized) — this is deliberately
// simple, not a full auth system.
...
function safeEqual(a: string, b: string): boolean {
  // Compare lengths first via a constant accumulator so we still scan.
