...
Object.assign(FR, {
  ...
  // donors
  'dn.totalDonors': 'Total donateurs',
  'dn.pctActive': '% actifs',
  'dn.activeSuffix': 'actifs',
  'dn.pctOptIn': '% Opt-In (RGPD)',
  'dn.consentRate': 'Taux de consentement',
  'dn.totalLtv': 'LTV totale',
  'dn.ltvHint': 'Valeur vie cumulée',
  ...
  'dn.snapshotNote': 'Instantané, non filtré par date. Les téléchargements couvrent toute la base.',
  // toasts
...
const EN: Dict = {
  ...
  'dn.totalDonors': 'Total donors',
  'dn.pctActive': '% active',
  'dn.activeSuffix': 'active',
  'dn.pctOptIn': '% Opt-In (GDPR)',
  'dn.consentRate': 'Consent rate',
  'dn.totalLtv': 'Total LTV',
  'dn.ltvHint': 'Cumulative lifetime value',
  ...
  'dn.snapshotNote': 'Snapshot, not filtered by date. Downloads cover the whole base.',
